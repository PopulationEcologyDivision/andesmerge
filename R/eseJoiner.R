eseJoiner <- function(eseList = NULL){
  ...
  sets <- drop_cols(sets, justDropNAs=T)
  sets <- drop_cols(sets, justDropNAs=F, uniformFields = 'drop')
  ...
  catches <- drop_cols(catches, justDropNAs=T)
  catches <- drop_cols(catches, justDropNAs=F, uniformFields = 'drop')
  #long to wide
  ...
  obs <- drop_cols(obs, justDropNAs=T)
  obs <- drop_cols(obs, justDropNAs=F, uniformFields = 'drop')
