...
loadESEData(cxnObj = cxn, source_df = results$ESE_MISSIONS,         target_table = "ANDESE_MISSIONS", confirmOverwrite = T)
loadESEData(cxnObj = cxn, source_df = results$ESE_SETS,             target_table = "ANDESE_SETS", confirmOverwrite = T)
loadESEData(cxnObj = cxn, source_df = results$ESE_BASKETS,          target_table = "ANDESE_BASKETS", confirmOverwrite = T)
loadESEData(cxnObj = cxn, source_df = results$ESE_CATCHES,          target_table = "ANDESE_CATCHES", confirmOverwrite = T)
loadESEData(cxnObj = cxn, source_df = results$ESE_SPECIMENS,        target_table = "ANDESE_SPECIMENS", confirmOverwrite = T)
loadESEData(cxnObj = cxn, source_df = results$ESE_LV1_OBSERVATIONS, target_table = "ANDESE_LV1_OBSERVATIONS", confirmOverwrite = T)
