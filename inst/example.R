...
# GLF_ORA <- read.csv(file ="c:/Users/McMahonM/OneDrive - DFO-MPO/SpeciesHarmonization/Gulf/species_20220912.csv", fileEncoding = "latin1")
# GLF_ORA$COMM_FR <- NULL
# GLF_ORA$SPEC <- toupper(GLF_ORA$SPEC)
# GLF_ORA$COMM <- toupper(GLF_ORA$COMM)
